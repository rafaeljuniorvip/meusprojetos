  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#0f1117' }}>
      <div className="text-center animate-fade-in">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">Catalogador de Projetos</h1>
        <p className="text-gray-500 text-sm mb-8">Faca login para continuar</p>
        <a href="/auth/login"
          className="inline-flex items-center gap-3 px-6 py-3 rounded-xl text-sm font-medium text-white transition-all hover:shadow-lg hover:scale-[1.02]"
          style={{ background: 'linear-gradient(135deg, #6366f1, #8b5cf6)' }}>
